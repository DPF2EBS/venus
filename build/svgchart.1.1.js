        ...
        _initAxis:function () {
            ...
            for (axis in axisOption) {
                ...
                if ((thisAxisOption = axisOption[axis])) {
                    ...
                    var thisAxis = new Axis(thisAxisOption, this.series, this.stage)
                    this.coordinate.push(axis, thisAxis);
            ...
            for(axis in this.coordinate.axises){
                this.coordinate.axises[axis].model.beginX = beginX;
                this.coordinate.axises[axis].model.beginY = opt.height- beginY;
            }
...
//                model.total = Math.ceil((model.max-model.min)/model.tickSize)+1;
        ...
        autoRange:function (min, max,totalTick) {
            ...
            dSolution = [1, 2, 2.5, 5, 10, 20, 25, 50, 100, 200, 250, 500];
